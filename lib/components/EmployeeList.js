          ...
          this.state.results.map(function (result) {
            return _react2['default'].createElement(_materialUi.ListItem, {
              ...
              rigthIconButton: _react2['default'].createElement(
                ...
                _react2['default'].createElement(_materialUi.MenuItem, { index: 0, primaryText: 'Edit' }),
                _react2['default'].createElement(_materialUi.MenuItem, { index: 1, primaryText: 'Delete' })
              )
            });
          })
        )
